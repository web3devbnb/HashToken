...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.cake = await HashToken.new({ from: alice });
    ...
    it('should also work with MasterGrower', async () => {
        ...
        this.chef = await MasterGrower.new(this.cake.address, this.syrup.address, dev, '1000', '0', { from: alice });
